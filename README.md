# Домашнее задание 1 - goit-nodejs-hw-01

# Ссылки на скриншоты выполненных команд:

## [Получаем и выводим весь список контактов в виде таблицы (console.table)](https://ibb.co/dp7kHgV)

## [Получаем контакт по id](https://ibb.co/ZB0GCr1)

## [Добавляем контакт](https://ibb.co/6JGPt40)

## [Удаляем контакт](https://ibb.co/wp68Rnq)
